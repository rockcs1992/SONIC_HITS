...
<div class="table">
  <AccordianItem :imageSrc="musicIcon" title="Music">
  	<span>
  ...
  <AccordianItem :imageSrc="soundDesignIcon" title="Sound Design">
  	<span>
  ...
  <AccordianItem :imageSrc="wrenchIcon" title="Interactive Design">
  	<span>
