...
import soundDesignIcon from '../assets/soundDesign.png'
import mixerIcon from '../assets/mixer.png'
import wrenchIcon from '../assets/wrench.png'
  export default {
    data(){
      return {
        musicIcon: musicIcon,
        soundDesignIcon: soundDesignIcon,
        mixerIcon: mixerIcon,
